...
function FilterSideBar() {
    ...
    return (
        <Grid container justify='flex-start' className={classes.root}>
            ...
            <Button variant='contained' color='primary' style={{ margin: 7 }}>Apply</Button>
            <Button variant='outlined' color='primary' style={{ margin: 7 }}>Reset</Button>
        </Grid >
    )
}
